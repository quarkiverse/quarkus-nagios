...
config_property_copy_button:+++quarkus.nagios.root-path+++[]
...
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.nagios.default-group+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.nagios.management.enabled+++[]
endif::add-copy-button-to-config-props[]
